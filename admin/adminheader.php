<?php
    ...
    if(!isset($_SESSION['email'])){
        echo "<script>window.location.assign('/Lkcproject/login.php?err=Login is required')</script>";
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Cateogry</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="addCategory.php" class="dropdown-item">Add</a>
                        <a href="manageCategory.php" class="dropdown-item">Manage</a>
